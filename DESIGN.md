---
version: alpha
name: WeaveQA-Claude-inspired-workbench
description: A warm, restrained QA workbench inspired by Claude/Anthropic's editorial calm, adapted for dense enterprise review workflows. The interface uses a warm canvas, serif headings, coral primary actions, low-saturation surfaces, and dark context panels for retrieved evidence. It does not copy Anthropic brand marks; the tone is professional, review-focused, and operational rather than promotional.
